...
A Ruby on Rails application for tracking bikes, components and maintenance history. Users can create an account, manage their bikes, and catalog reusable components, install components on bikes and record maintenance logs tied to bikes and components.
...
3. **Component Management**
   - Create a shared catalog of components (e.g., chains, tires, cassettes)
   - Components have a name, type, and optional expected lifespan in kilometers

4. **Bike-Component Installation**
   - Install components on bikes with an installation date and current kilometer reading
   - Remove components from a bike without deleting the component catalog entry
   - Validation prevents duplicate installations and future installation dates
...
| `/components` | Manage shared component catalog |
